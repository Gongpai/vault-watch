...
**Feature count:** 30 delivered · 2 in progress · 6 planned (38 Product Backlog stories)
...
| Storage-first topology UI | 🚧 In Progress — overview and privacy-safe node details delivered; remaining taxonomy/theme work pending | [US-MON-32](./agile/user-stories/US-MON-32.md) |
