...
| Native health backends + privilege broker | 🚧 In Progress — opt-in ATA SMART status reaches TUI through the authenticated broker; broader metrics and qualification pending | [Sprint 10](./agile/sprint-backlogs/sprint-10.md) |
