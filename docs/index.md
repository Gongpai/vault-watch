...
**Last Updated:** 2026-07-13 | **Target Platform:** Ubuntu/Debian · Fedora · Arch · openSUSE · Alpine
...
| Native health backends + privilege broker | 🚧 In Progress — opt-in ATA SMART status and generation-safe runtime grant reconciliation implemented; broader metrics and qualification pending | [Sprint 10](./agile/sprint-backlogs/sprint-10.md) |
