...
| Storage-first topology UI | 🚧 In Progress — topology overview delivered, remaining detail/availability/theme work pending | [US-MON-32](./agile/user-stories/US-MON-32.md) |
