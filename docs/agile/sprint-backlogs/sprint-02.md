...
| [US-MON-12](../user-stories/US-MON-12.md) | **History Buffer & Graph UI**<br>- เพิ่ม history ring buffers ใน AppState (VecDeque × 60 samples)<br>- Inline Sparkline ในคอลัมน์ Temp/Read/Write ของ disk table<br>- Sparkline RAID rebuild speed ใน RAID panel<br>- Full Chart view (Graph View) toggle ด้วย `Tab` | kong | 10 | 🔵 Planned |
